...
- Package locally: `./Scripts/package_app.sh` to refresh `CodexBar.app`, then restart the bundle from this checkout with `pkill -x CodexBar || pkill -f CodexBar.app || true; open -n "$PWD/CodexBar.app"`.
