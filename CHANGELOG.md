...
- Release: verify the packaged dSYM UUIDs match the signed app binary before zipping debug symbols, so uploaded symbols cannot silently drift away from the shipped build.
